...
- (void)setLayout
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[_contentLabel]-5-[_authorLabel]-5-|" options:NSLayoutFormatAlignAllLeft metrics:nil views:views]];
