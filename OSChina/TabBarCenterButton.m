...
- (void)installTheButton {
    CGPoint pointToSuperview = [self buttonLocationForIndex:2];
...
- (CGPoint)buttonLocationForIndex:(NSUInteger)index {
    UIBarButtonItem *item = [self.tabBar.items objectAtIndex:index];
