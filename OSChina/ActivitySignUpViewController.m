...
@property (nonatomic, strong) UITextField        *corporateNameTextfield;
@property (nonatomic, strong) UITextField        *positionNameTextfield;
...
- (void)viewDidLoad {
    ...
    RAC(_saveButton,alpha) = [valid map:^id(NSNumber *b) {
