...
- (void)viewDidLoad {
    ...
    NSArray *controllers = @[[[TweetsViewController alloc] initWithTweetsType:TweetsTypeAllTweets],
    ...
    NSArray *controllers = @[[[PostsViewController alloc] initWithPostsType:PostsTypeQA],
