...
- (instancetype)initWithUserId:(int64_t)userID {
    ...
    [manager GET:[NSString stringWithFormat:@"%@%@?uid=%lld&hisuid=%lld&pageIndex=0&pageSize=20",OSCAPI_PREFIX,OSCAPI_USER_INFORMATION,[Config getOwnID],userID] parameters:nil success:^(AFHTTPRequestOperation *operation, ONOXMLDocument *responseDocument) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    for (UIView *view in countView.subviews) {
        view.translatesAutoresizingMaskIntoConstraints = NO;
    }
